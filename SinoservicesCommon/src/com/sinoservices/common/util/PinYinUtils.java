...
public class PinYinUtils {
	 ...
	 * 单字解析
	 * 
	 * @Title: convertWordSingle
	 * @Description: TODO
	 * @param str
	 * @return
	 * @return String
	 */
	private static String convertWordSingle(String str) {
		String result = null;
	 ...
	 * 单字首字母
	 * 
	 * @Title: initialWordSingle
	 * @Description: TODO
	 * @return
	 * @return String
	 */
	private static String initialWordSingle(String str) {
		String result = convertWordSingle(str);
		if (result == null || result.trim().equals("")) {
			return "";
		}
	 ...
	 * 词组解析
	 * 
	 * @Title: convertWordGroup
	 * @Description: TODO
	 * @param str
	 * @return
	 * @return String
	 */
	public static String convertWordGroup(String str) {
		String key, value;
		StringBuilder buffer = new StringBuilder();
		for (int i = 0; i < str.length(); i++) {
			key = str.substring(i, i + 1);
			if (key.getBytes().length >= 2) {
				value = (String) convertWordSingle(key);
	...
	public static String initialWordGroup(String str) {
		...
		for (int i = 0; i < str.length(); i++) {
			key = str.substring(i, i + 1);
			if (key.getBytes().length >= 2) {
				value = (String) initialWordSingle(key);
			} else if (key == null || key.trim().equals("")) {
				value = "";
			} else {
				value = key;
