...
import com.sinoservices.common.exception.XXAdressMalformedException;
...
public class XMPPHelper {
    ...
    /**组合成name@xx格式**/
	public static String SaveServer(String account) {
		...
		while (localMatcher.find()) {
			...
			if (m - k < 8) {
				if (App.getInstance().getFaceMap().containsKey(str2)) {
					int face = App.getInstance().getFaceMap().get(str2);
