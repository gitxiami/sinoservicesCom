...
public class OfflineActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.map_offlinemap_activity);
		init();
	}
	...
	private void init() {
		...
		expandableListView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if (isStart) {
					OfflineActivity.this.groupPosition = groupPosition;
					OfflineActivity.this.childPosition = childPosition;
				}
				return false;
			}
		});
	...
	final ExpandableListAdapter adapter = new BaseExpandableListAdapter() {
		...
		public View getGroupView(int groupPosition, boolean isExpanded,
			...
			if (convertView == null) {
				convertView = (RelativeLayout) RelativeLayout.inflate(
						getBaseContext(), R.layout.map_offlinemap_group, null);
			}
		...
		public View getChildView(final int groupPosition,
			...
			if (convertView == null) {
				convertView = (RelativeLayout) RelativeLayout.inflate(
						getBaseContext(), R.layout.map_offlinemap_child, null);
			}
			...
			if (cityMap.get(groupPosition).get(childPosition).getState() == OfflineMapStatus.SUCCESS) {
				...
				if (groupPosition == OfflineActivity.this.groupPosition
						&& childPosition == OfflineActivity.this.childPosition) {
	...
	public void onDownload(int status, int completeCode, String downName) {
		...
		case OfflineMapStatus.LOADING:
			OfflineActivity.this.completeCode = completeCode;
			break;
